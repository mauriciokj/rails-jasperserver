...
module JasperserverRails
  class DetailsController < ApplicationController
    def show
      if params[:id] == "gerar"
        report_execution = ReportExecution.new(report: "/reports/interactive/relatorio_dispensacao_municipe", format: 'pdf', params: {"data_inicio" => "2018-01-01", "data_fim" => "2018-04-02", "hidden_title" => false})
